...
export default function OrderConfirmationScreen({
  ...
  return (
    <div
      className="relative flex h-auto min-h-screen w-full flex-col items-center bg-background-light dark:bg-background-dark group/design-root overflow-y-auto p-4 sm:p-6 pb-8"
      style={{
        backgroundImage:
